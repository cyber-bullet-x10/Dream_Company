...
8. **회차별 진전 — 같은 사건 반복 절대 금지**: 각 편은 이전 편에서 시간이 (몇 주~몇 달) 흐른 뒤의 '새로운 국면'을 다룬다. **이전 편과 같은 성취(같은 매출·같은 승진·같은 오픈)를 문구만 바꿔 되풀이하지 말 것** — 지금까지 가장 크게 어기던 규칙이다. 시리즈 전체가 하나의 성장 서사가 되도록: 편이 올라갈수록 새로운 도전·확장·다음 단계로 나아간다. '오늘 신문 날짜'가 이전 편보다 상당히 뒤(수 주~수 개월 후)이므로 그 사이 벌어진 변화·다음 이야기를 반영한다. 이전 편은 자연스럽게 이어받되 반복이 아니라 '그다음'을 쓴다.
